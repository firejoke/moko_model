...
with open(db_config, 'r') as f:
    ...
    charset = re.search(
        ...
        flags=re.I).group()[
        8:] or 'utf8'
    DATABASE_DEFAULT = '{}+{}://{}:{}@{}:{}/{}?charset={}'.format(
        db, drive, user, password, host, port, name, charset)
...
HEADERS_DEFAULT = {
    ...
    (KHTML, like Gecko) Chrome/67.0.3396.62 '
    'Safari/537.36'}
...
COOKIES = dict(
    ...
    Hm_lvt_8d82e75c6168ba4bc0135a08edae2a2e='1530839622,1530925845,\
    1530941756,1531019852',
